...
class CastingAgencyUnitTest(unittest.TestCase):
    ...
    def test_get_movies(self):
        response = self.client().get(
            '/movies', headers={"Authorization": (casting_assit_token)})
    ...
    def test_get_actors(self):
        response = self.client().get(
            '/actors', headers={"Authorization": (casting_assit_token)})
        data = json.loads(response.data)
    ...
    def test_patch_movie(self):
        response = self.client().patch('/movies/1', json=self.update_movie,
                                       headers={"Authorization":
                                                (casting_direct_token)})
        data = json.loads(response.data)
    ...
    def test_patch_actor(self):
        response = self.client().patch('/actors/1', json=self.update_actor,
                                       headers={"Authorization":
                                                (casting_direct_token)})
        data = json.loads(response.data)
    ...
    def test_delete_movie(self):
        response = self.client().delete(
            '/movies/2', headers={"Authorization": (casting_direct_token)})
        data = json.loads(response.data)
    ...
    def test_delete_actor(self):
        response = self.client().delete(
            '/actors/2', headers={"Authorization": (casting_direct_token)})
        data = json.loads(response.data)
    ...
    def test_404_update_movies(self):
        response = self.client().patch('/movies/100', json=self.update_movie,
                                       headers={"Authorization":
                                                (casting_direct_token)})
        data = json.loads(response.data)
    ...
    def test_404_update_actors(self):
        response = self.client().patch('/actors/100', json=self.update_actor,
                                       headers={"Authorization":
                                                (casting_direct_token)})
        data = json.loads(response.data)
    ...
    def test_404_delete_movies(self):
        response = self.client().delete(
            '/movies/100', headers={"Authorization": (executive_prod_token)})
        data = json.loads(response.data)
    ...
    def test_404_delete_actors(self):
        response = self.client().delete(
            '/actors/100', headers={"Authorization": (executive_prod_token)})
        data = json.loads(response.data)
    ...
    def test_401_delete_movies(self):
        response = self.client().delete(
            '/movies/3', headers={"Authorization": (casting_assit_token)})
        data = json.loads(response.data)
    ...
    def test_401_delete_actors(self):
        response = self.client().delete(
            '/actors/3', headers={"Authorization": (casting_assit_token)})
        data = json.loads(response.data)
    ...
    def test_404_get_movies(self):
        response = self.client().get(
            '/movies/100', headers={"Authorization": (casting_assit_token)})
        data = json.loads(response.data)
    ...
    def test_404_get_actors(self):
        response = self.client().get(
            '/actors/100', headers={"Authorization": (casting_assit_token)})
        data = json.loads(response.data)
